                  ...
                  <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card card-profile">
                      <div class="card-avatar">
                        <a href="javascript:;">
                          <img class="img" src="{{URL::asset('images/categories/')}}{{'/'.$value->image}}" />
                        </a>
                      </div>
                      <div class="card-body">
                        <h4 class="card-title">{{$value->category}}</h4>
                        <p class="card-description">
                          {{$value->description}}
                        </p>
                        <a href="{{url($current_menu.'/get_sub_categories/'.$provider_id.'/'.$encrypt_id)}}" class="btn btn-primary btn-round">
                ...
                @else
                  <div class="mx-auto">
                    <div class="card card-profile">
                      <div class="card-avatar">
                        <a href="javascript:;">
                          <img class="img" src="../assets/img/exclamation-mark.png" />
                        </a>
                      </div>
                      <div class="card-body">
