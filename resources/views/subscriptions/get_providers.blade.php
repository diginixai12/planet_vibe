      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary">
            <h4 class="card-title">Select Provider</h4>
          ...
          <div class="card-body">
            ...
            @endif
            <form action="{{route($current_menu.'.get_categories')}}" method="POST" enctype="multipart/form-data">
            {!! csrf_field() !!}
              <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label class="bmd-label-floating" for="provider-id"> Select Provider <span style="color: red">*</span> </label>
                      <select class="form-control" id="provider-id" name="provider_id"  required="">
                        @if(!empty($providers))
