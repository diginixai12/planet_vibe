                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating" for="category"> Category <span style="color: red">*</span> </label>
                          <input class="form-control" id="category" type="text" name="category" value="{{ $records->category }}" required="">
                        </div>
                      </div>
                    </div>
                    <div class="row">
