@include('layouts.common')
      ...
      <div class="content">
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-3">
              <a href="{{url($current_menu.'/create')}}" class="btn btn-primary btn-lg">
                <i class="material-icons">add_box</i> Add New Sub Category
              </a>
            </div>
          </div>
          <div class="row">
    ...
    $(function () {
          var table = $('.data-table').DataTable({
              ...
              columns: [
                  ...
                  {data: 'monthly_days', name: 'monthly_days'},

                  {data: 'monthly_price', name: 'monthly_price'},

                  {data: 'quarterly_days', name: 'quarterly_days'},
                  
                  {data: 'quarterly_price', name: 'quarterly_price'},

                  {data: 'halfyearly_days', name: 'halfyearly_days'},
